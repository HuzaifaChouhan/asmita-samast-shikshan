...
const BG_VIDEO_SRC =
  "/videos/coverr-temp-8i3tgen-3-alpha-2290351142-a-title-screen-with-nuzu9694acolorful-mp4-7090-1080p.mp4";
  ...
  useEffect(() => {
    if (heroHeadRef.current) {
      ...
      heroHeadRef.current.innerHTML = text
        ...
        .map(
          (w) =>
            `<span style="display:inline-block;overflow:hidden;"><span style="display:inline-block;transform:translateY(100%)">${w}</span></span>`,
        )
        .join(" ");
  ...
  return (
    <main>
      ...
      >
        ...
        {/* ── Hero content ── */}
        <div
          className="container-custom w-full py-24 relative"
          style={{ zIndex: 2 }}
        >
          <div className="max-w-2xl">
            ...
            >
              <OrdText>
                Academic tuition for 1st–12th standard — including 11th &amp;
                12th across Science, Commerce, and Arts — alongside Zumba
                fitness programs for women. Available offline and online.
              </OrdText>
            </p>
        ...
        <div className="container-custom">
          <motion.div {...fadeUp} className="mb-14">
            ...
            <p
              ...
              style={{ fontSize: "1rem" }}
            >
              Academic excellence and active wellness — everything under one
              roof in Powai.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div
                className="relative p-8 md:p-10 h-full flex flex-col justify-between"
              ...
              >
                <div>
                  ...
                  <p className="text-white/45 text-xs mb-4">
                    Science · Commerce · Arts for{" "}
                    <OrdText>11th &amp; 12th</OrdText> · Offline &amp; Online
                  </p>
            ...
            >
              <div className="absolute inset-0">
                ...
                <div
                  ...
                  style={{ backgroundColor: "rgba(159, 18, 57, 0.72)" }}
                />
              </div>
              <div
                className="relative p-8 md:p-10 h-full flex flex-col justify-between"
              ...
              >
                <div>
                  ...
                  >
                    Energetic fitness sessions designed to build strength and
                    endurance in a supportive community.
                  </p>
                </div>
                <Link
                  to="/zumba"
        ...
        <div className="container-custom">
          <motion.div {...fadeUp} className="mb-12 text-center">
            ...
            >
              Learn Your Way —
              <br />
              <span style={{ color: "#D97706" }}>Online</span> or{" "}
            ...
            >
              All academic tuition and Zumba classes are available in two modes.
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to top, rgba(15,23,42,0.88) 0%, rgba(15,23,42,0.35) 60%, transparent 100%)",
                }}
              />
              {/* Content */}
              <div
              ...
              >
                ...
                <p className="text-white/65 text-sm mb-5 max-w-xs">
                  Attend in person at our centre in Powai. A focused, structured
                  environment with direct teacher interaction.
                </p>
                <Link
                  to="/tuition"
                  className="inline-flex items-center gap-1.5 font-semibold text-sm text-amber-400"
                >
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to top, rgba(15,23,42,0.90) 0%, rgba(15,23,42,0.35) 60%, transparent 100%)",
                }}
              />
              {/* Amber glow accent */}
              <div
              ...
              >
                ...
                <p className="text-white/65 text-sm mb-5 max-w-xs">
                  Learn from wherever you are. Tuition and Zumba both available
                  online — quality support beyond the classroom.
                </p>
                <Link
                  to="/admissions"
                  className="inline-flex items-center gap-1.5 font-semibold text-sm text-amber-400"
      ...
      >
        <div className="container-custom">
          <motion.div {...fadeUp} className="mb-14">
            ...
            <p
              className="text-white/50 mt-3 max-w-lg"
              style={{ fontSize: "1rem" }}
            >
              <OrdText>
                A complete academic pathway — from 1st standard through 12th,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="flex flex-col gap-0">
              {[
                {
                  range: <OrdText>1st – 5th</OrdText>,
                  label: "Primary",
                  delay: 0,
                },
                {
                  range: <OrdText>6th – 8th</OrdText>,
                  label: "Middle School",
                  delay: 0.08,
                },
                {
                  range: <OrdText>9th – 10th</OrdText>,
                  label: "Secondary",
                  delay: 0.16,
                },
                {
                  range: <OrdText>11th – 12th</OrdText>,
                  label: "Arts · Commerce · Science",
                  delay: 0.24,
                  highlight: true,
                },
              ].map((step, i, arr) => (
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-xs">
                      <OrdText>1st to 10th Standard</OrdText>
                    </p>
                  </div>
                </div>
                <p className="text-white/50 text-sm leading-relaxed">
                  Comprehensive academic support for all grades and subjects —
                  concept-based learning with personal attention.
                </p>
                <Link
                  to="/tuition"
                  className="inline-flex items-center gap-1.5 text-amber-400 text-sm font-semibold mt-4"
                >
              ...
              <motion.div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(217,119,6,0.12) 0%, rgba(217,119,6,0.04) 100%)",
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-amber-400/70 text-xs">
                      11th &amp; 12th Standard — New
                    </p>
                  </div>
                </div>
                <p className="text-white/50 text-sm leading-relaxed">
                  Arts, Commerce, and Science — academic support for 11th and
                  12th students preparing for their future.
                </p>
                <Link
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white/35 text-xs mt-0.5">
                    Learn from wherever you are — academic support accessible
        ...
        <div className="container-custom">
          <motion.div {...fadeUp} className="mb-12">
            ...
            <p
              ...
              style={{ fontSize: "1rem" }}
            >
              Everything about Asmita's Samast Shikshan is built around clarity,
              personal attention, and a safe space to thrive.
            </p>
          </motion.div>
      ...
      >
        <div className="container-custom">
          <motion.div {...fadeUp} className="mb-12">
            ...
            <p
              className="text-slate-500 mt-3 max-w-md"
              style={{ fontSize: "1rem" }}
            >
            ...
            {[
              {
                ...
                desc: (
                  <OrdText>
                    Decide between Tuition Classes for your child (1st–10th) or
                    Zumba sessions for women.
                  </OrdText>
                ),
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeUp}>
              ...
              <p
                ...
                style={{ fontSize: "0.95rem" }}
              >
                302, Samoa Building, Pacific Enclave,
                <br />
                Opp. Dr. L H Hiranandani Hospital,
                <br />
                Powai, Mumbai — 400076
              </p>
              <div className="flex flex-wrap gap-3">
                <a href="tel:+919869911317" className="btn-primary">
        ...
        <div className="container-custom text-center">
          <motion.div {...fadeUp}>
            ...
            <p
              ...
              style={{ fontSize: "1rem" }}
            >
              Whether it's tuition for your child or Zumba for yourself — we'd
