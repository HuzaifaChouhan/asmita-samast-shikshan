...
const programTypes = [
  {
    ...
    sub: (
      <>
        <Ord>1st</Ord> to <Ord>10th</Ord> · All Subjects
      </>
    ),
    accent: "#1E40AF",
    bg: "#EFF6FF",
...
function AdmissionForm() {
  ...
  const validate = () => {
    ...
    if (isSchoolTuition && !form.studentClass)
  ...
  const handleSubmit = async (e) => {
    ...
    // Map frontend state to Django backend model fields
    const payload = {
      full_name: form.name,
    ...
    try {
      ...
      setApiError(
        "Network error. Make sure your Django backend server is running.",
      );
    } finally {
    ...
    return (
      ...
      >
        ...
        <p className="text-slate-500 mb-6 max-w-xs">
          Thank you for reaching out. We'll get in touch with you shortly to
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
      ...
      <div>
            ...
            return (
              ...
              >
                ...
                <p
                  ...
                  style={{
                    color: isSelected ? pt.accent : "#94a3b8",
        ...
        {errors.programType && (
          <p className="text-rose-500 text-xs mt-1">{errors.programType}</p>
        )}
      </div>
        ...
        {isSeniorSecondary && (
          ...
          >
            ...
            <div>
              ...
              {errors.standard && (
                <p className="text-rose-500 text-xs mt-1">{errors.standard}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.stream && (
                <p className="text-rose-500 text-xs mt-1">{errors.stream}</p>
              )}
            </div>
          </motion.div>
        )}
        ...
        {showLearningMode && (
          ...
          >
            ...
            <div
              ...
              role="group"
              aria-label="Select preferred learning mode"
            >
              {learningModes.map((lm) => {
                ...
                return (
                  <button
                    ...
                    onClick={() =>
                      setForm((prev) => ({ ...prev, learningMode: lm.value }))
                    }
                    aria-pressed={isSel}
                  ...
                  >
                    ...
                    <div>
                      <p
                        ...
                        style={{ color: isSel ? "#D97706" : "#0F172A" }}
                      >
                        {lm.label}
                      </p>
      ...
      >
        {isSubmitting ? "Sending..." : "Send Inquiry"} <ArrowRight size={16} />
      </button>
    </form>
  );
}
      ...
      >
        <div className="container-custom">
          <div className="max-w-2xl">
            ...
            <p
              className="text-white/65 max-w-lg"
              style={{ fontSize: "1rem", lineHeight: "1.8" }}
            >
              Tell us what you're looking for and we'll help you understand the
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <h3
                className="font-bold mb-1"
                style={{ color: "#9F1239", fontSize: "1.05rem" }}
              >
                Zumba Classes
              </h3>
