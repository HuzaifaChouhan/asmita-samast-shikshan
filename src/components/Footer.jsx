...
export default function Footer() {
  return (
    <footer
      ...
      style={{
        background: "linear-gradient(180deg, #1e2d6b 0%, #131c47 100%)",
      }}
      role="contentinfo"
    >
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-xs">
              A dedicated education and wellness center in Powai, Mumbai —
              offering tuition for <Ord>1st</Ord>–<Ord>12th</Ord> class students
              and Zumba fitness classes for women.
            </p>
            ...
            <ul className="flex flex-col gap-2.5">
              ...
              <li>
                <p className="text-white/40 text-xs mt-1">
                  <Ord>1st</Ord> – <Ord>10th</Ord> Class
                </p>
              </li>
              <li>
              ...
              <li>
                <p className="text-white/40 text-xs mt-1">
                  <Ord>11th</Ord> – <Ord>12th</Ord> Class
                </p>
              </li>
              <li>
      ...
      <div style={{ borderTop: "1px solid rgba(201,168,76,0.15)" }}>
        <div className="container-custom py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="text-white/30 text-xs">Powai, Mumbai — 400076</p>
        </div>
      </div>
    </footer>
  );
